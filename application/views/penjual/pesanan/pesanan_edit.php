...
<body id="page-top">
                        ...
                        <div class="col-12">
                            <div class="card shadow">
                                <div class="card-header">
                                    <a class="btn btn-sm text-primary" href="<?php echo site_url('pesananku') ?>"><i class="fas fa-arrow-left mr-1"></i> Kembali<span class="hide-mobile"> ke data pesanan</span></a>
                                </div>
                                <div class="card-body">
                                   <div class="col py-2">
                                        ...
                                        <form action="<?=site_url('pesananku/simpan_edit_pesanan')?>" method="post" onsubmit="return dataValidation()">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-10">
                                                    <input type="date" class="form-control <?php echo form_error('tgl_dipesan') ? 'is-invalid':'' ?>"
                                                     id="tgl_dipesan"  name="tgl_dipesan"  placeholder="" min="<?=Date("Y-m-d")?>"
                                                     value="<?= $pesanan->tgl_dipesan ?>">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-10">
                                                    <input type="date" class="form-control <?php echo form_error('tgl_diambil') ? 'is-invalid':'' ?>"
                                                     id="tgl_diambil"  name="tgl_diambil"  placeholder="" min="<?=Date("Y-m-d")?>"
                                                     value="<?= $pesanan->tgl_diambil ?>">
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-10">
                                                    <input type="text" class="form-control <?php echo form_error('nama') ? 'is-invalid':'' ?>"
                                                     ...
                                                     value="<?= $pesanan->nama_pemesan ?>" readonly>
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-10">
                                                    <input type="number" class="form-control <?php echo form_error('no_hp') ? 'is-invalid':'' ?>"
                                                     ...
                                                     value="<?= $pesanan->no_hp_pemesan ?>" readonly>
                                                    <div class="invalid-feedback">
                                            ...
                                            <input type="hidden" name="hargaRadio" value="harga_satuan_reseller">
                                            ...
                                            <div class="barang-group-dynamic">
                                                <?php foreach($detail_pesanans as $detail_pesanan):?>
                                                    <div class="remove">
                                                        <input type="hidden" name="idDetail[]" value="<?= $detail_pesanan->id_detail_pesanan ?>">
                                                        <div class="form-group form-row mb-4 mb-lg-3">
                                                                ...
                                                                <div class="input-group input-group-sm">
                                                                    <select class="custom-select" name="idBarang[]">
                                                                        ...
                                                                        <?php foreach($barangs as $barang): ?>
                                                                            <option value="<?=$barang->id_barang?>"  <?php echo ($detail_pesanan->id_barang == $barang->id_barang) ? " selected" : "" ?>><?=$barang->nama_barang?></option> 
                                                                        <?php endforeach;?>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-3 mb-2 mb-lg-0">
                                                                ...
                                                                value="<?= $detail_pesanan->jml_barang ?>">
                                                            </div>
                                                            <div class="col-lg-4 mb-2 mb-lg-0">
                                                                <div class="input-group input-group-sm">
                                                                    <div class="input-group-prepend">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-7 col-sm-6 text-lg-right"><span class="d-lg-none d-inline">Total</span></div>
                                                <div class="col-lg-5 col-sm-6 p-lg-0">
                                            ...
                                            <span>*) harap konfirmasi ke suplier setelah melakukan perubahan pesanan</span>
    ...
    <script>
        ...
        function countJmlSubtotal(object){
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    if(len > 0){
                        // Read values
                        var jenisHarga = $("input[name='hargaRadio']").val();
                        var harga = 0;
                        var total = 0;
        ...
        function dataValidation(){
            ...
            if(selects.value != "" || inputs[1].value != "" ){
            ...
            reverseFormatting(); // create price to number/remove formating number
            if(emptyInput){
