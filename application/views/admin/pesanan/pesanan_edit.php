                            ...
                            <div class="card shadow">
                                ...
                                <div class="card-body">
                                   <div class="col py-2">
                                        ...
                                        <form action="<?=site_url('pesanan/simpan_edit_pesanan')?>" method="post" onsubmit="return dataValidation()">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-10">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="hargaRadio" id="hargaRadio1" value="harga_satuan_normal" 
                                                        <?= ($pesanan->jenis_harga == "harga_satuan_normal")? " checked": " " ?>>
                                                    ...
                                                    <div class="form-check">
                                                        ...
                                                        <?= ($pesanan->jenis_harga == "harga_satuan_reseller")? " checked": " " ?>>
                                        ...
                                        <div class="text-right small <?=(!isset($pesanan))? ' d-none': '' ?>">
                                            <div class="row">
                                                <div class="col">Dibuat :</div>
                                                <div class="col-auto"><?=$pesanan->date_created?></div>
                                            </div>
                                            <div class="row">
                                                <div class="col">Terakhir diperbarui :</div>
                                                <div class="col-auto"><?=$pesanan->date_modified?></div>
                                            </div>
                                        </div>
