                        ...
                        <div class="col-12">
                            <div class="card shadow ">
                                <div class="card-header">
                                    Laporan global harian
                                </div>
                                <div class="card-body">
                                    <div class="col py-2">
                                        <form action="<?=current_url()?>" method="post" class="form-bulan">

                                            <div class="form-row align-items-top justify-content-md-end">
                                                <div class="form-group col-auto mb-0">
                                                    <input type="month" class="form-control form-control-sm <?php echo form_error('tgl') ? 'is-invalid':'' ?>"
                                                    id="tgl"  name="tgl"  
                                                    <?php echo isset($date) ? 'value="'.date('Y-m',strtotime($date)).'"': "" ?>>
                                                    <div class="invalid-feedback">
                                                        <?php echo form_error('tgl') ?>
                                                    </div>
                                                </div>
                                                <div class="col-auto pb-2"><input type="submit" value="OK" class="btn btn-primary btn-sm"></div>
                                            </div>
    ...
    <script>
        $(document).ready( function () {
            var t = $('#laporanTable').DataTable( {
                "dom": "<'text-left mb-1 topdttbl row'<'col-md-6 p-0'B>><'row '<'col-md-6 col-sm-12'l><'col-md-6 col-sm-12'f>>rtip",
                "columnDefs": [ {
                    "searchable": false,
                    "orderable": false,
                    "targets": 0
                ...
                "buttons": [
                        ...
                        
                        {
                            ...
                            "title": "Laporan Harian - "+tanggalIndo($('input[name="tgl"]').val(), "bln")
                        },
            ...
            $('input[name="tgl"]').valueAsDate = new Date();

            $('.form-bulan').clone().appendTo('.topdttbl');
            $('.topdttbl .form-bulan').attr("class", "col-md-6 p-0");
            $('.form-bulan').remove();
