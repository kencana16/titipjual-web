...
<body id="page-top">
                            ...
                            <div class="card shadow">
                                ...
                                <div class="card-body">
                                   <div class="col py-2">
                                        ...
                                        <form action="<?=site_url('pesananku/simpan_pesanan')?>" method="post" onsubmit="return dataValidation()">
                                            ...
                                            <input type="hidden" name="idPenjual" value="<?=$this->session->userdata('id_penjual')?>">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-10">
                                                    <input type="text" class="form-control <?php echo form_error('nama') ? 'is-invalid':'' ?>"
                                                     id="nama"  name="nama"  placeholder="" value="<?=$this->session->userdata('username')?>" readonly>
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-10">
                                                    <input type="number" class="form-control <?php echo form_error('no_hp') ? 'is-invalid':'' ?>"
                                                     id="no_hp"  name="no_hp"  placeholder="" value="<?=$this->session->userdata('no_hp')?>" readonly>
                                                    <div class="invalid-feedback">
    ...
    <script>
        ...
        function countJmlSubtotal(object){
            ...
            var IntJumlah = Number.isInteger(jumlah) ? 0 : jumlah;
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    if(len > 0){
                        // Read values
                        var harga = response[0].harga_satuan_reseller;
                        var total = 0;
